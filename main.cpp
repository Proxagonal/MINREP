...
int main() {
    ...
    string str = R"(Body #0:
Mass: 1.5104399515165556
Position:  -4.2939406687661847 -0.64369425216722886
Velocity: 0.75286942812145519 -2.2536745407691079
Body #1:
Mass: 1.2203501655691493
Position:  2.0314683616657092 0.77180908392939651
Velocity: 0.78637333783724017  4.4387138430116151
Body #2:
Mass: 1.0401973719123532
Position:   3.8518043711963124 0.029210006191499271
Velocity: -2.0157856116133246 -1.9349646168011145)";
    initialData init = Bodyfold::stringToInitialData(str);

    //Solver solver(1000000, pow(10, -3), init); //000
