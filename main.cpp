...
int main() {
    ...
    string str = R"(Body #0:
Mass: 1.1566453733881221
Position: 7.1535370789910999 7.0528782281467155
Velocity:   1.112512649470327 -1.5233571346217498
Body #1:
Mass: 0.57516603196678251
Position: -1.5438449187770296 -9.6971774631168763
Velocity: -1.174599031112094 1.3711341917211088
Body #2:
Mass: 1.4206189622152796
Position: -5.1992396316832199 -1.8162448605455577
Velocity: -0.43023017517361772  0.68516202818664151)";
    initialData init = Bodyfold::stringToInitialData(str);

    Solver solver(100000, pow(10, -4), init); //000

    //Solver solver(100000, pow(10, -4));
