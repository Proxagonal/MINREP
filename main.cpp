...
int main() {
    ...
    string str = R"(Body #0:
Mass: 1.3900883910732211
Position: 125678.03280678681 79311.968409719426
Velocity: -0.19429959349479353 -0.12046813822617294
Body #1:
Mass: 1.5264165269014081
Position: -157210.63994619087 -99215.956761178022
Velocity:  -0.0012372191500896433 -0.00077084987244708549
Body #2:
Mass: 0.51933296091519254
Position: 125671.48506410715 79321.422983790661
Velocity: 0.52371434421378094 0.32472038383354007)";
    initialData init = Bodyfold::stringToInitialData(str);

    Solver solver(16500000, pow(10, -3), init); //000
