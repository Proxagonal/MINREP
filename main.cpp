...
int main() {
    ...
    string str = R"(Body #0:
Mass: 1.0772802598567723
Position: 12.003198127899424 3.7411718016616717
Velocity:  0.92190123623732312 -0.64654367473315055
Body #1:
Mass: 1.4231058624048254
Position: -9.2941249790811824 -3.9329239637840878
Velocity: -0.99742516542818649   0.3536217819019507
Body #2:
Mass: 0.54401642090108415
Position: 0.54357797661315921  2.8798333256111501
Velocity: 0.78360795835691199 0.35526042891583387)";
    initialData init = Bodyfold::stringToInitialData(str);

    Solver solver(10000000, pow(10, -3), init); //000
